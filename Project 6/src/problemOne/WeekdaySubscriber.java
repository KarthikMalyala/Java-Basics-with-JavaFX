...
// Karthik Malyala
//
// Includes the child class of the NewsPaperSubscriber class called WeekdaySubscriber that has a constructor with a string
// parameter to initialize the street address and calls the setRate() abstract method to set the rate, which in the case of a 
// seven-day subscriber is $7.5. In addition, it includes a toString method that outputs subscription info
//
//*********************************************
public class WeekdaySubscriber extends NewsPaperSubscriber {
	// Constructor with string parameter
	public WeekdaySubscriber(String strAddress) {
		// TODO Auto-generated constructor stub
		super(strAddress);
	}
	// Calls the abstract method to set the subscription rate
	public void setRate() {
		subscriptionRate = 7.5;
	}
	...
	public String toString() {
		...
		result += "\nService Type: Weekday Subscription";
